...
function getParseFunction(parserName, conf){
  ...
  //     <h4 class="accordion-title text-center" role="tab" tabindex="0">Read more</h4>
  ...
  // --------------------------------------------------------------------
  acetate.markdown.use(markdownItContainer, "esri-read-more",
    {
      marker: ">",
      validate: function(params) { 
      ...
      render: function(tokens, idx) {
        ...
        if (/container_esri-read-more_open/i.test(tokens[idx].type)) {
          return `<div class="esri-read-more accordion js-accordion" aria-live="polite" role="tablist">
      <div class="accordion-section" aria-expanded="true">
        <h4 class="accordion-title text-center" role="tab" tabindex="0">Read more</h4>
        <div class="accordion-content">\n`;
        }
