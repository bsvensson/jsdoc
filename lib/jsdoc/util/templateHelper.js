...
function buildLink(longname, linkText, options) {
    ...
    // (but skip anything that looks like an inline tag or HTML tag)
        ...
        if ( longname.toLowerCase() === 'array.<string>' || longname.toLowerCase() === 'object.<string, string>') {
            ...
            // TODO: be smarter, parse it and check the individuals
        ...
        if (!fileUrl) {
            if (text.toLowerCase() === 'boolean') {
                ...
                fileUrl = 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date';
            } else if (text === 'Error') {
                fileUrl = 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error';
            } else if (text === 'Object') {
                fileUrl = 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object';
            } else if (text === 'HTMLSpanElement') {
                fileUrl = 'https://developer.mozilla.org/en-US/docs/Web/API/HTMLSpanElement';
            } else if (text === 'ProgressEvent') {
                fileUrl = 'https://developer.mozilla.org/en-US/docs/Web/API/ProgressEvent';
            } else if (text === 'XMLHttpRequest') {
                fileUrl = 'https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest';
            } else if (text === 'Promise') {
                fileUrl = 'http://dojotoolkit.org/reference-guide/1.10/dojo/promise/Promise.html#dojo-promise-promise';
            }
        }
    }
